...
module.exports = class Unmute extends Command {
    ...
    async execute(interaction, args) {
        ...
        const success = await interaction.member.guild.editMember(member.id, { communicationDisabledUntil: null });
        ...
        return (new modLogs(this.client, interaction)).postModLog(`${interaction.member.mention} has unmuted ${member.mention}`, {
            name: 'Information',
