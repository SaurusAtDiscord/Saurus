...
declare namespace Eris {
  ...
  type PrivateChannelTypes = Constants["ChannelTypes"][keyof Pick<Constants["ChannelTypes"], "DM">];
  ...
  type InteractionContent = Pick<WebhookPayload, "content" | "embed" | "embeds" | "allowedMentions" | "tts" | "flags" | "components">;

  type InteractionEditContent = Pick<WebhookPayload, "content" | "embed" | "embeds" | "allowedMentions" | "components">;
  ...
  export class Client extends EventEmitter {
    ...
    editSelf(options: { avatar?: string; username?: string }): Promise<User>;
    ...
    getRESTGuildChannels(guildID: string): Promise<AnyGuildChannel[]>;z
